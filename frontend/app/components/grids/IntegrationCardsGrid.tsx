...
export default function IntegrationCardsGrid(props: any) {
    ...
    return (
        <>
            <IntegrationCard signupBtn={<SalesforceAuthButton customText="Signup with Salesforce" />} title='Salesforce' url='salesforce.com' description='Import all kinds of contacts from your Salesforce CRM.' hasLoginFeature logo={<SalesforceFullLogo w={80} />} />
            <IntegrationCard signupBtn={<ZohoAuthButton customText="Signup with Zoho" />} title='Zoho' url='zoho.com' description='Import leads, contacts and vendors from your Zoho CRM.' hasLoginFeature logo={<ZohoFullLogo w={"80px"} />} />
            ...
            <IntegrationCard signupBtn={<MailchimpAuthButton customText="Signup with MailChimp" />} title='Mailchimp' url='mailchimp.com' description="Import your audiences' contacts from Mailchimp." hasLoginFeature logo={<MailchimpFullLogo w='90px' />} />
            <IntegrationCard title='SendGrid' url='sendgrid.com' description='Import your contacts from the SendGrid marketing platform.' logo={<SendgridFullLogo w='110px' />} />
