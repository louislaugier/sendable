        ...
        <>
            <Card key={index} className="max-w-md p-6 pb-0" style={{ width: 320 }}>
                ...
                <div className="pt-2 pb-4">
                    ...
                    {isPremium && <p className="absolute text-sm">About <b>${Math.round((isYearly ? Math.round(plan.yearlyPrice / 12) : plan.monthlyPrice) / (limits.premium.app + limits.premium.api) * 10000) / 10000}</b> per checked email.</p>}
